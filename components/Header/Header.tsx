...
export function Header() {
  return (
      <header className="shadow px-8 py-3">
          <div className="container mx-auto grid grid-cols-12 items-center gap-4">
              {/* Left: Logo or icon */}
              <div className="col-span-2 flex items-center w-8 h-8 cursor-pointer">
              ...
              <div className="col-span-8">
                  <div className="relative">
                      ...
                      />
                      <MagnifyingGlassIcon className="w-8 h-8 text-gray-400 absolute left-3 top-1/2 transform -translate-y-1/2 cursor-pointer " />
                  </div>
              </div>
